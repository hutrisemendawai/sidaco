                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <x-text-input id="number_of_fisher" class="block mt-1 w-full" type="number" name="number_of_fisher" :value="old('number_of_fisher')" required />
                                    </div>
                                </div>
                        ...
                        <div class="tab-content hidden" id="water-quality">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="suhu" class="block mt-1 w-full" type="number" step="0.1" name="suhu" :value="old('suhu')" />
                                </div>

                                <!-- pH Air -->
                                <div>
                                    <x-input-label for="ph_air" :value="__('pH (Water)')" />
                                    <x-text-input id="ph_air" class="block mt-1 w-full" type="number" step="0.1" min="0" max="14" name="ph_air" :value="old('ph_air')" />
                                </div>

                                <!-- Salinitas -->
                                <div>
                                    <x-input-label for="salinitas" :value="__('Salinity (PSU)')" />
                                    <x-text-input id="salinitas" class="block mt-1 w-full" type="number" step="0.1" min="0" name="salinitas" :value="old('salinitas')" />
                                </div>

                                <!-- Hujan -->
                                <div class="flex items-end">
                                    <label class="flex items-center cursor-pointer">
                                        <input type="checkbox" name="hujan" value="1" {{ old('hujan') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" />
                        ...
                        <div class="tab-content hidden" id="stage">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div id="sampling-wrapper" class="hidden">
                                    ...
                                    <x-text-input id="sampling" class="block mt-1 w-full" type="number" min="0" name="sampling" :value="old('sampling')" />
                                </div>
                            </div>
                        </div>
