        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg rounded-xl">
                <div class="p-8 bg-white">
                    ...
                    <form method="POST" action="{{ route('sidat.update', $sidat->id) }}" enctype="multipart/form-data" class="space-y-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="date" class="block mt-2 w-full py-2.5" type="date" name="date" :value="old('date', $sidat->date->format('Y-m-d'))" required />
                                </div>
                        ...
                        <div class="border-b-2 border-gray-100 pb-8">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div class="lg:col-span-1">
                                    ...
                                    <div id="photo-preview-container" class="mt-2 {{ $sidat->fish_photo ? '' : 'hidden' }}">
                                        @if($sidat->fish_photo)
                                            <img id="photo-preview" src="{{ asset('storage/' . $sidat->fish_photo) }}" alt="Photo Preview" class="w-full h-64 object-cover rounded-lg cursor-pointer border-2 border-blue-300 hover:border-blue-500 transition shadow-md" onclick="openPhotoModal()" />
                                        @else
                                    ...
                                    <!-- Upload Zone -->
                                    <div id="photo-upload-zone" class="mt-2 {{ $sidat->fish_photo ? 'hidden' : '' }} flex justify-center px-6 pt-8 pb-8 border-2 border-gray-300 border-dashed rounded-lg hover:border-blue-400 hover:bg-blue-50 transition cursor-pointer" onclick="document.getElementById('fish_photo').click()">
                                ...
                                <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div class="flex items-end">
                                        <label class="flex items-center cursor-pointer p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition flex-1">
                                            <input type="checkbox" name="hujan" value="1" {{ old('hujan', $sidat->hujan) ? 'checked' : '' }} class="w-5 h-5 rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500 cursor-pointer" />
